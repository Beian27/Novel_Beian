...
<link href="${pageContext.request.contextPath}/style/css/common_style_blue.css" rel="stylesheet"
	type="text/css" />
<style type="text/css">
body {
	margin: 0;
...
<body>
	...
	<div id="StatusBar">
		...
		<div id="StatusBar_Links">
			<a href="http://gz.itcast.cn" target="_blank"></a>后台管理
		</div>
		<!-- 右侧功能按钮 -->
		<div id="StatusBar_Right">
			<!-- 版本 -->
			<a href="javascript:void(0)"> <img border="0" width="11"
				height="11" src="${pageContext.request.contextPath}/style/images/info.gif" /> <img border="0"
