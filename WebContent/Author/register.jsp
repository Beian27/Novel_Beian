...
<body class="login-bg">
	<div class="login layui-anim layui-anim-up">
		...
		<form method="post" class="layui-form"
			action="${pageContext.request.contextPath}/AuthorAddServlet">
			<input name="authorName" placeholder="用户名" type="text"
				lay-verify="required" class="layui-input">
			<input name="authorAccount" placeholder="账号" type="text"
				lay-verify="required" class="layui-input">
			<hr class="hr15">
			<input name="authorPassword" lay-verify="required" placeholder="密码"
				type="password" class="layui-input">
			<hr class="hr15">
			<input value="注册" lay-submit lay-filter="login" style="width: 100%;"
				type="submit">
			<input value="zc" type="hidden" name="zzzq">
			<hr class="hr20">
			<div class="Row">
				<div class="Column">
					<a href="${pageContext.request.contextPath}/frontend/index.jsp">返回前台</a>
				</div>
