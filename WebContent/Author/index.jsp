...
<frameset rows="100px,*,19px" framespacing="0" border="0"
	frameborder="0">
	<frame src="${pageContext.request.contextPath}/Author/top.jsp" scrolling="no"
		noresize />
	<frameset cols="178px,*">
		<frame noresize src="${pageContext.request.contextPath}/Author/left.jsp"
			scrolling="yes" />
		<frame noresize name="right"
			src="${pageContext.request.contextPath}/Author/right.jsp" scrolling="yes" />
	</frameset>
	<frame noresize name="status_bar" scrolling="no"
		src="${pageContext.request.contextPath}/Author/bottom.jsp" />
</frameset>
<noframes>
	<body>
		你的浏览器不支持框架布局，推荐你使用
