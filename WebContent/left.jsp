...
#Menu .level1 .level1Style {
	background:
		url("${pageContext.request.contextPath}/style/images/img/menu_btn_bg.gif")
...
#Menu .level1 .MenuLevel2 .level2Style {
	...
	width: 112px;
	background-image:
		url(${pageContext.request.contextPath}/style/images/img/menu_arrow_single.gif);
	...
	<ul id="Menu">
		<li class="level1">
			<div onClick="menuClick(this);" class="level1Style">
				<img
					src="${pageContext.request.contextPath}/style/images/func20001.gif"
					class="Icon" /> 系统菜单/折叠
			</div>
			<ul class="MenuLevel2">
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.request.contextPath}/ReaderListServlet">读者信息管理</a>
				</li>
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.request.contextPath}/AuthorListSerlvet">作者信息管理</a>
				</li>
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.request.contextPath}/ClassifyListServlet">小说分类管理</a>
				</li>
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.request.contextPath}/NovelListServlet">小说信息管理</a>
				</li>
			</ul>
		</li>
	</ul>
