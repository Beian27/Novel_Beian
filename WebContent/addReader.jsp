				...
				<div class="ItemBlock">
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								<!-- <input type="hidden" name="readerId" value="addReader"> -->
								<td width="80px">读者名：</td>
								<td><input required="required" type="text"
									name="readerName" class="InputStyle" value= /> *</td>
							</tr>
							<tr>
								<td width="80px">读者账号</td>
								<td><input required="required" type="text"
									name="readerAccount" class="InputStyle" value= /> *</td>
							</tr>
							<tr>
								<td width="80px">读者密码</td>
								<td><input required="required" type="text"
									name="readerPassword" class="InputStyle" value= /> *</td>
							</tr>
						</table>
					</div>
				</div>
